                    ...
                    <tbody>
                        @foreach($posts as $post)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('carrier-post.show', $post)}}" class="btn btn-success btn-sm float-left">View</a>
                                    ...
                                    <form onsubmit="return confirm('Are you sure?')" action="{{route('carrier-post.destroy', $post)}}" method="post" id="request_form_{{$post->id}}">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
